...
import { ProyectoSchemaResponse, UnidadSchemaResponse, type ProyectoType, type ProyectoTypeResponse, type UnidadType, type UnidadTypeResponse } from "../types/generalTypes";

const getAll = async (page: number =1, pageSize: number = 4): Promise<ProyectoTypeResponse> => {
